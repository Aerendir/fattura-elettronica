...
$fpr12 = new SimpleXMLElement($root);

# 1  FatturaElettronicaHeader
$FatturaElettronicaHeader = $fpr12->addChild('FatturaElettronicaHeader', null, '');
...
# 1.1.1.2 IdCodice
$IdCodice = $IdTrasmittente->addChild('IdCodice', '01234567890');
...
$FormatoTrasmissione = $DatiTrasmissione->addChild('FormatoTrasmissione', 'FPR12');

# 1.1.4 CodiceDestinatario
$CodiceDestinatario = $DatiTrasmissione->addChild('CodiceDestinatario', 'ABC1234');
...
$FatturaElettronicaBody = $fpr12->addChild('FatturaElettronicaBody');
...
$validator->validateSimpleXMLElement($fpr12);
